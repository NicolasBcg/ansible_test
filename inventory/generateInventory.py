...
uis=["o","oui","y","yes","uoi","ou","ui","eys","yse"]#liste d'entrees utilisateurs etants considerees comme etant "oui"
def main():
    ...
    yaml_file = open(input("nom sous lequel enregistrer l'inventaire : ")+".yml", 'w')
